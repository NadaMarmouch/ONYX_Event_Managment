...
var phone_v = document.getElementsByName('phone-v')[0] ;
// submit event
form.addEventListener('submit', function(event){
  ...
  var phoneV = phone_number.value.trim() ;
  ...
  checkEmpty(phone_number,phoneV,"You cannot leave the phone number field empty!",phone_v,event) ;
