...
<section id="sideber" class="sideber">
    <ul class="sideber__ber">
        ...
        <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
            ...
            <a href="Admin1.php"><i id="left" class="fas fa-tachometer-alt"></i>Dashboard</a>
                                                                </li>
            <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
                                                                        echo " active";
                                                                    }?>">
                <a href="addAdmin.php"><i id="left" class="fas fa-address-card"></i></i>All Admin</a>
            </li>
    <footer class="text-center"><span>Pharmacy</span><br>©2020 Pharmacy All right reserved.</footer>
</section>

<!--------------------------------- Main section -------------------------------->
<section class="main"><h1> ALL USERS </h1>
  <div class="container" style="top:550px">
  <div class="tablev" style="top:350px">
      
  <table class="table" style="top:350px;font-size: 24px;">
    <thead>
        <tr>
          <th scope="col">#</th>
